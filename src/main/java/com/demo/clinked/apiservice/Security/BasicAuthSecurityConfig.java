package com.demo.clinked.apiservice.Security;
...
public class BasicAuthSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public BasicAuthSecurityConfig(@Qualifier("userDetailsServiceImpl") UserDetailsService userDetailsService) {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/articleStats/**").hasRole(Role.ADMIN)
                // any authenticated user can perform all other operations
                .antMatchers("/articles/**").hasAnyRole(Role.ADMIN, Role.USER).and().httpBasic()
